...
# -*- coding: utf-8 -*-
#
# minkit documentation build configuration file, created by
...
# minkit.core.decorate (which calls functools.wrap), only "*args, **kwargs"
...
def no_op_wraps(func):
    ...
    Sphinx documentation. This must be done before "minkit" is imported.
    '''
    if func.__module__ is None or 'minkit' not in func.__module__:
...
#
sys.path.insert(0, os.path.abspath(minkit.PACKAGE_PATH))
...
version = minkit.__version__
# The full version, including alpha/beta/rc tags.
release = minkit.__version__
...
latex_documents = [
    (master_doc, 'minkit.tex', u'minkit Documentation',
...
man_pages = [
    (master_doc, 'minkit', u'minkit Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'minkit', u'minkit Documentation',
     author, 'minkit', 'One line description of project.',
     'Miscellaneous'),
]
